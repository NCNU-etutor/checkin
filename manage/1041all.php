...
?>
  <ul id="Tab" class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="#1041firsttab" role="tab" data-toggle="tab">期初教育訓練</a></li>
  ...
  <div id="userTabContent" class="tab-content">
    <div class="tab-pane fade in active" id="1041firsttab">
...
<?php require("datatables.html"); ?>
    $('#1041first, #1041wordgame, #1041yuchihmeeting, #1041pingjingmeeting, #1041hezuomeeting, #1041wordgame2').DataTable(opt);
  });
</script>
